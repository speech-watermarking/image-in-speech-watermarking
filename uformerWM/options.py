...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--arch', type=str, default ='Uformer_audio',  help='archtechture')
        # parser.add_argument('--arch', type=str, default ='WMNetCNNAudio',  help='archtechture')
        ...
        parser.add_argument('--in_chans', type=int, default=1, help='in_chans')
        parser.add_argument('--image_scale', type=float, default=1, help='image_scale')
        parser.add_argument('--audio_scale', type=str, default='0', help='audio_scale')
        ...
        parser.add_argument('--modulator', action='store_true', default=True, help='multi-scale modulator')
        ...
        parser.add_argument('--train_dir', type=str, default ='../datasets/denoising/sidd/train',  help='dir of train data')
        parser.add_argument('--val_dir', type=str, default ='../datasets/denoising/sidd/train',  help='dir of train data')
