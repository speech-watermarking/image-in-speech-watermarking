...
def train(wm_ds, train_dl):
    ...
    for epoch in range(start_epoch, opt.nepoch + 1):
        ...
        for i, batch_data in enumerate(tqdm(train_dl), 0):
            ...
            target = data
            input_ = data
            audio, wm_decode  = model_restoration(input_, message)
            ...
            loss2 = criterion_audio(wm_decode, message)
            ...
            if i % 10 == 0:
                ...
                print("Epoch {}, Step {}, Total loss: {}, audio mse loss: {}, Watermark decode loss: {}".format(epoch, i, loss, loss1, loss2))
                loss_file.write("Epoch {}, Step {}, Total loss: {}, audio mse loss: {}, Watermark decode loss: {}\n".format(epoch, i, loss, loss1, loss2))
